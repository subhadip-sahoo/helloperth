                        ...
                        <?php while(have_posts()): the_post(); ?>
                            <div class="grid-row-4"> 
                                <section class="payment-table-block text-center">
                                    ...
                                    <div class="payment-table-month-area">per <?php echo get_post_meta(get_the_ID(), 'interval_count', true).' '.ucwords(get_post_meta(get_the_ID(), 'interval', TRUE)); ?><?php echo (get_post_meta(get_the_ID(), 'interval_count', true) > 1) ? 's' : '';?> (Inc. GST)</div>
