            ...
            <div class="left-blocks-container">
                <section class="section-blocks perth-tourist-map-section clearfix">
                    <header class="section-blocks-header">
                        ...
                        <a href="<?php echo href(MAPS_PAGE); ?>" class="btn btn-view-download hide-tablet">View Download PDF maps <i class="fa fa-arrow-circle-o-right"></i></a>
                        <p>We have the best tourist maps to help you make the most os your visit in Perth. <a href="<?php echo href(TRANSPORT_PAGE); ?>">Click here</a> for Transport <a href="<?php echo href(PERTH_TRANSIT_MAPS); ?>">train and bas maps </a>, <a href="<?php echo href(EXCLUSIVE_DISCOUNT_PAGE); ?>">Perth shopping guides,</a> <a href="<?php echo href(MAPS_PAGE); ?>">maps of Fremantle</a> and more</p>
                    </header>
                    <section class="section-blocks-contentarea">
                        ...
                        <?php $button_names = array('Discounts', 'Events', 'General Info'); ?>
                                ...
                                <li class="grid-row-3">
                                    <div class="perth-slider-box">
                                        <div class="perth-tourist-lists-image">
                                            ...
                                            <a href="<?php echo ($i == 2)? site_url().'/general-info': href($id); ?>">
                                            ...
                                            <h3 class="parth-slider-title">
                                                <a href="<?php echo ($i == 2)? site_url().'/general-info': href($id); ?>"><?php echo (($id == NEWS_N_EVENTS_PAGE) ? 'Events in Perth' : (($id == TOURIST_INFO_PAGE) ? 'General Info' : $page->post_title)); ?> <i class="icon icon-arrow"></i></a>
                                            </h3>
                                        </div>
        ...
        <div class="inner-main-base-container">
            ...
            <article class="guides-available-content">
                ...
                <div class="grid-row">
                    ...
                    <div class="grid-row-3"><a href="<?php echo (get_field('android_link', 'option') <> '') ? get_field('android_link', 'option') : '#'; ?>" class="btn btn-guides-available" target="_blank"><i class="icon icon-download3"></i><span>Google play Android App</span></a></div>
                    <div class="grid-row-3 clearleft"><a href="<?php echo get_field('pdf_guide_download', 'option'); ?>" class="btn btn-guides-available" target="_blank"><i class="icon icon-download1"></i><span>PDF Guide download (13mb)</span></a></div>
